...
# Generate Repository and RepositoryImpl classes
import os
import sys
...
directory = os.path.join(BASE_DIR, "domain", "repositories")
...
# -------------------------
def generate_repository(file_name, class_name):
    template = f"""
...
# -------------------------
def generate_repository_impl(file_name_impl, class_name_impl, attributes):
    # build attributes string first
    attributes_str = "".join(
...
generate_repository(file_name, class_name)
...
generate_repository_impl(file_name_impl, class_name_impl, attributes)
